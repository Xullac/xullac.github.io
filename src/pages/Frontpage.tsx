    ...
    return (
        <>
            <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50">
                ...
                {/* Hero Section */}
                <div className="pt-56 pb-20 px-6">
                    <div className="max-w-6xl mx-auto">
                        <div className="text-center space-y-6">
                            ...
                            {/*    A passionate Full Stack Engineer crafting beautiful digital experiences.*/}
                        ...
                        <div className="grid md:grid-cols-3 gap-8">
                            <div
                                ...
                                <p className="text-gray-600">
                                    Building modern, scalable applications with React, Node.js, and TypeScript.
                                </p>
                            </div>
                            ...
                            <div
                                ...
                                <p className="text-gray-600">
                                    Leading Agile teams and coordinating with international distributed engineers.
                                </p>
                            </div>
                        </div>
                    </div>
